...
DISCLAIMER = (
    "This report is generated by an AI-based prototype using a synthetic dataset. "
    "The repayment score is an estimated model output and does not guarantee loan "
    "approval, repayment, or financial outcome. Real-world deployment would require "
    "validation using representative real-world data, appropriate governance, and "
    "regulatory and fairness assessment."
)
